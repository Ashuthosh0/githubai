...
const BillingPage = ()=>{
    ...
    const { data: userCreditsData } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$trpc$2f$react$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].project.getMyCredits.useQuery();
    const credits = userCreditsData?.credits || 0;
    const [creditsToBuy, setCreditsToBuy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([
        100
    ]);
    ...
    const handleBuyCredits = async ()=>{
        try {
            ...
            if (!order.id) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Failed to create Razorpay order.');
                return;
            }
            ...
            const options = {
                ...
                handler: async function(response) {
                    ...
                    if (verifyResponse.ok) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(result.error || 'Payment verification failed.');
                    }
                },
                prefill: {
                    name: user?.firstName || '',
...
//# sourceMappingURL=_5a2ef723._.js.map