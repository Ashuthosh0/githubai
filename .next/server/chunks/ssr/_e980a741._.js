...
//                   This proejct is linked to {''}</p> 
//                   <Link href = {project?.githubUrl ?? ""} className ="inline-flex items-center text-white/80 hover:underline">{project?.githubUrl}</Link>
//                 </div>
//             </div>
//           </div>
//         </div>
...
//# sourceMappingURL=_e980a741._.js.map