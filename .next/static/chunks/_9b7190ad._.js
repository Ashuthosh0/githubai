...
const BillingPage = ()=>{
    ...
    const { data: userCreditsData } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$trpc$2f$react$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].project.getMyCredits.useQuery();
    const credits = userCreditsData?.credits || 0;
    const [creditsToBuy, setCreditsToBuy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        100
    ]);
    const creditsToBuyAmount = creditsToBuy[0];
    const amountInINR = creditsToBuyAmount / 50 // 50 credits per INR
    ;
    const price = amountInINR.toFixed(2);
    const handleBuyCredits = async ()=>{
        try {
            ...
            if (!order.id) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to create Razorpay order.');
                return;
            }
            // Step 2: Initialize Razorpay Checkout
            const options = {
                key: ("TURBOPACK compile-time value", "rzp_test_InIhpNsOwDzhVh"),
                amount: order.amount,
                ...
                handler: async function(response) {
                    // Step 3: Send payment verification to server
                    ...
                    if (verifyResponse.ok) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(result.error || 'Payment verification failed.');
                    }
                },
                prefill: {
                    name: user?.firstName || '',
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-sm",
                        children: "E.g. If your project has 100 files, you will need 100 credits."
                    }, void 0, false, {
                        fileName: "[project]/src/app/(protected)/billing/page.tsx",
                        lineNumber: 90,
                        columnNumber: 9
...
_s(BillingPage, "YV3AwCB02lc3yp+GI8zeDYP81PA=", false, function() {
    return [
...
//# sourceMappingURL=_9b7190ad._.js.map